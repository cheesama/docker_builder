...
process.on('SIGTERM', () => {
  ...
  console.log('Closing node-red server.');
  this.close(() => {
    console.log('node-red server closed.');
  });
});
...
module.exports = {
    ...
    //        username: "admin",
            //Applied_nl1
    //        password: "$2a$08$SnZsETPYnq//9WJ8rOfyuOWIVnbI8xkNLCeGJ//GidVLnmd.0S6om",
    //        permissions: "*"
    //    }]
    //},
